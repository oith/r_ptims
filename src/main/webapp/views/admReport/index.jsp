    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Adm Report</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='admModule' text='Adm Module'/></th>
                    <th class='center bold'><spring:message code='fileName' text='File Name'/></th>
            ...
            <c:if test='${not empty admReports}'>
                <c:forEach items='${admReports}' var='admReport'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:out value='${admReport.admModule!=null ? admReport.admModule :"N/A"}'/></td>
                        <td><c:out value='${admReport.fileName}'/></td>
                        <td><c:if test='${admReport.isActive}'><spring:message code='default.boolean.true' text='YES'/></c:if><c:if test='${!admReport.isActive}'><spring:message code='default.boolean.false' text='NO'/></c:if></td>
                        ...
                        <td><c:out value='${admReport.remarks}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/admReport/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/admReport/show/${admReport.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/admReport/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/admReport/edit/${admReport.id}'>
                            ...
                            <sec:access url='/admReport/copy'>
                                <li>
                                <a class='btn btn-block btn-warning btn-xs' href='${pageContext.request.contextPath}/admReport/copy/${admReport.id}'>
                                    <i class='fa fa-clone' aria-hidden='true'></i> <spring:message code='default.button.copy.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/admReport/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/admReport/delete/${admReport.id}' onclick='return confirm('Are you sure to delete?');'>
