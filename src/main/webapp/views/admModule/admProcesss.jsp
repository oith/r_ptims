        ...
        <table class='table table-bordered table-striped table-hover table-condensed dt-responsive display nowrap th-center'>
            <thead>
                <tr>
                    ...
                    <td><spring:message code='query' text='Query'/></td>
                    <td><spring:message code='queryAlias' text='Query Alias'/></td>
                    <td><spring:message code='isActive' text='Is Active'/></td>
                    <td><spring:message code='slNo' text='Sl No'/></td>
                    <td><spring:message code='paramSearchs' text='Param Searchs'/></td>
                    <td><spring:message code='paramFixeds' text='Param Fixeds'/></td>
                    <td><spring:message code='processBtns' text='Process Btns'/></td>
            ...
            <tbody>
                <c:forEach items='${admModule.admProcesss}' var='admProcesss'  varStatus='loopStatus'>
                    ...
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:out value='${admProcesss.paramSearchs}'/></td>
                        <td><c:out value='${admProcesss.paramFixeds}'/></td>
