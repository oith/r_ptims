    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.copy.label' text='Copy'/> Course Founded</h1>
                <ul class='top-links'>
                    <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${pageContext.request.contextPath}/courseFounded/copy'  commandName='courseFounded' method='POST'>
                        <div class='box-body'>
