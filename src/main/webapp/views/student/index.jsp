    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Student</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='experienceInInfoTech' text='Experience In Info Tech'/></th>
            ...
            <c:if test='${not empty students}'>
                <c:forEach items='${students}' var='student'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:url var='picFile' value='/student/getPhotoTumb/${student.picFile}'/>
<img alt='${student.picFile}' src='${picFile}'/></td>
                        <td><c:out value='${student.fullName}'/></td>
                        <td><c:out value='${student.gender}'/></td>
                        <td><fmt:formatDate value='${student.dob}' type='date' pattern='dd/MM/yyyy'/></td>
                        <td><c:out value='${student.email}'/></td>
                        <td><c:out value='${student.addressPermanent.lineOne}'/></td>
                        <td><c:out value='${student.addressPermanent.lineTwo}'/></td>
                        <td><c:out value='${student.addressPermanent.street}'/></td>
                        <td><c:url var='addressPermanent_city' value='/student/getPhotoTumb/${student.addressPermanent.city}'/>
<img alt='${student.addressPermanent.city}' src='${addressPermanent_city}'/></td>
                        <td><c:out value='${student.addressPermanent.zip}'/></td>
                        <td><c:out value='${student.addressPresent.lineOne}'/></td>
                        <td><c:out value='${student.addressPresent.lineTwo}'/></td>
                        <td><c:out value='${student.addressPresent.street}'/></td>
                        <td><c:url var='addressPresent_city' value='/student/getPhotoTumb/${student.addressPresent.city}'/>
<img alt='${student.addressPresent.city}' src='${addressPresent_city}'/></td>
                        <td><c:out value='${student.addressPresent.zip}'/></td>
                        <td><c:out value='${student.experienceInInfoTech}'/></td>

                           <td class='center action'>
                            <ul class='top-links'>
                            <sec:access url='/student/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/student/show/${student.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/student/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/student/edit/${student.id}'>
                                    <i class='fa fa-edit'></i> <spring:message code='edit.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/student/copy'>
                                <li>
                                <a class='btn btn-block btn-warning btn-xs' href='${pageContext.request.contextPath}/student/copy/${student.id}'>
                                    <i class='fa fa-clone' aria-hidden='true'></i> <spring:message code='default.button.copy.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/student/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/student/delete/${student.id}' onclick='return confirm('Are you sure to delete?');'>
