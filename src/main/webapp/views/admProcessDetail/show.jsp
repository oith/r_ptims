                ...
                <span class='property-value' aria-labelledby='admZoneType'>
                    <c:out value='${admProcessDetail.admZoneType}'/>
                        ...
                        <div class='box-footer'>
                            ...
                            <a href='${pageContext.request.contextPath}/admProcessDetail/copy/${admProcessDetail.id}' class='btn btn-warning'><i class='fa fa-clone'></i> <spring:message code='default.button.copy.label'/></a>             
                            <a href='${pageContext.request.contextPath}/admProcessDetail/delete/${admProcessDetail.id}' class='btn btn-danger' onclick='return confirm('Are you sure to delete?');'><i class='fa fa-remove'></i> <spring:message code='delete.link.label'/></a>
                        </div>      <!--.box-footer-->
                    </div>      <!--.box .box-primary-->
                </section>      <!--.content-->
            </div>      <!--.content-wrapper-->
