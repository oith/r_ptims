    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Adm Process Detail</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='admProcess' text='Adm Process'/></th>
                    <th class='center bold'><spring:message code='admParam' text='Adm Param'/></th>
                    <th class='center bold'><spring:message code='admZoneType' text='Adm Zone Type'/></th>
            ...
            <c:if test='${not empty admProcessDetails}'>
                <c:forEach items='${admProcessDetails}' var='admProcessDetail'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        <td><c:out value='${admProcessDetail.slNo}'/></td>
                        ...
                        <td><c:out value='${admProcessDetail.admZoneType}'/></td>

                           <td class='center action'>
                            <ul class='top-links'>
                            <sec:access url='/admProcessDetail/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/admProcessDetail/show/${admProcessDetail.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/admProcessDetail/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/admProcessDetail/edit/${admProcessDetail.id}'>
                                    <i class='fa fa-edit'></i> <spring:message code='edit.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/admProcessDetail/copy'>
                                <li>
                                <a class='btn btn-block btn-warning btn-xs' href='${pageContext.request.contextPath}/admProcessDetail/copy/${admProcessDetail.id}'>
                                    <i class='fa fa-clone' aria-hidden='true'></i> <spring:message code='default.button.copy.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/admProcessDetail/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/admProcessDetail/delete/${admProcessDetail.id}' onclick='return confirm('Are you sure to delete?');'>
