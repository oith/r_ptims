...
<div>  
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='joiningDate'><spring:message code='joiningDate' text='Joining Date'/></form:label>
            <div class='input-group'>
                <div class='input-group-addon'><i class='fa fa-calendar'></i></div>
                <form:input class='form-control dtp-date' path='joiningDate' required='true'  />
             </div>
            <form:errors path='joiningDate' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label class='required' path='salary'><spring:message code='salary' text='Salary'/></form:label>
            <form:input class='form-control' path='salary' type='number' required='true' size='15' maxlength='15'/>
            <form:errors path='salary' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='speciality'><spring:message code='speciality' text='Speciality'/></form:label>
            <form:textarea class='form-control' path='speciality' type='text' size='30' maxlength='500'/>
            <form:errors path='speciality' cssClass='error' element='div'/>
        </div>
    </div>
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            <form:label path='courses'><spring:message code='courses' text='Courses'/></form:label>
            <form:select class='form-control' path='courses' name='courses' id='courses'  multiple='true'>
                <form:options items='${courses}' itemValue='id'/>
            </form:select>
            <form:errors path='courses' cssClass='error' element='div'/>
        </div>
    </div>
