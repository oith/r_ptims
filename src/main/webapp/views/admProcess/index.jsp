        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='query' text='Query'/></th>
                    <th class='center bold'><spring:message code='queryAlias' text='Query Alias'/></th>
                    ...
                    <th class='center bold'><spring:message code='paramSearchs' text='Param Searchs'/></th>
                    <th class='center bold'><spring:message code='paramFixeds' text='Param Fixeds'/></th>
                    <th class='center bold'><spring:message code='processBtns' text='Process Btns'/></th>
            ...
            <c:if test='${not empty admProcesss}'>
                <c:forEach items='${admProcesss}' var='admProcess'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:out value='${admProcess.admModule!=null ? admProcess.admModule :"N/A"}'/></td>
                        ...
                        <td><c:out value='${admProcess.paramSearchs}'/></td>
                        <td><c:out value='${admProcess.paramFixeds}'/></td>
