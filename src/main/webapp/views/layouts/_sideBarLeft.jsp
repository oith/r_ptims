        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<%=request.getContextPath()%>/refresh"><i class="fa fa-refresh"></i>  Refresh Session</a></li>
                    <li><a href="<%=request.getContextPath()%>/excelFileUpload"><i class="fa fa-file"></i>  Excel File Upload</a></li>
                    <li><a href="<%=request.getContextPath()%>/processCenter"><i class="fa fa-gears"></i> Process</a></li>
                    <li><a href="<%=request.getContextPath()%>/queryCenter"><i class="fa fa-search"></i> Query Center</a></li>
