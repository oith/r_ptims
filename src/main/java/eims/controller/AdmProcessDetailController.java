...
import eims.service.AdmProcessDetailService;
...
public class AdmProcessDetailController extends _OithController {
    ...
    public String save(@ModelAttribute(MODEL) @Valid AdmProcessDetail currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_CREATED, admProcessDetail.getId());
    ...
    public String edit(@PathVariable("id") BigInteger id, ModelMap model, RedirectAttributes attributes) {
        ...
        AdmProcessDetail admProcessDetail = admProcessDetailService.findById(id);
    ...
    public String update(@ModelAttribute(MODEL) @Valid AdmProcessDetail currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()){
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_EDITED, admProcessDetail.getId());
                return "redirect:/" + SHOW + "/" + admProcessDetail.getId();
            } catch (Exception e) {
                errorHandler(bindingResult, e);
            }
    ...
    public String copied(@ModelAttribute(MODEL) @Valid AdmProcessDetail currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    public String delete(@PathVariable("id") BigInteger id, RedirectAttributes attributes) {
        ...
        try {
            AdmProcessDetail deleted = admProcessDetailService.delete(id);
