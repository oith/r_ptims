...
import eims.service.AuthQuestionService;
...
public class AuthQuestionController extends _OithController {
    ...
    public String save(@ModelAttribute(MODEL) @Valid AuthQuestion currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_CREATED, authQuestion.getId());
    ...
    public String edit(@PathVariable("id") BigInteger id, ModelMap model, RedirectAttributes attributes) {
        ...
        AuthQuestion authQuestion = authQuestionService.findById(id);
    ...
    public String update(@ModelAttribute(MODEL) @Valid AuthQuestion currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()){
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_EDITED, authQuestion.getId());
                return "redirect:/" + SHOW + "/" + authQuestion.getId();
            } catch (Exception e) {
                errorHandler(bindingResult, e);
            }
    ...
    public String copied(@ModelAttribute(MODEL) @Valid AuthQuestion currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes ) {
    ...
    public String delete(@PathVariable("id") BigInteger id, RedirectAttributes attributes) {
        ...
        try {
            AuthQuestion deleted = authQuestionService.delete(id);
